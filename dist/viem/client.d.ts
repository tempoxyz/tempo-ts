...
export declare function createTempoClient<transport extends Transport, chain extends Chain | undefined = typeof tempo, accountOrAddress extends Account | Address | undefined = undefined, rpcSchema extends RpcSchema | undefined = undefined>(parameters?: createTempoClient.Parameters<transport, chain, accountOrAddress, rpcSchema>): import("viem").Client<transport | import("viem").HttpTransport<undefined, false>, {
    ...
    token: {
        ...
        getUserToken: (...parameters: (accountOrAddress extends `0x${string}` ? {
            ...
            address: accountOrAddress;
            type: "json-rpc";
        } : accountOrAddress) ? T extends Account ? [] | [import("./actions/token.js").getUserToken.Parameters<Account & (accountOrAddress extends `0x${string}` ? {
            address: accountOrAddress;
            type: "json-rpc";
        } : accountOrAddress)>] : [import("./actions/token.js").getUserToken.Parameters<accountOrAddress extends `0x${string}` ? {
            address: accountOrAddress;
            type: "json-rpc";
        } : accountOrAddress>] : never : never) => Promise<import("./actions/token.js").getUserToken.ReturnType>;
        ...
        setUserToken: (parameters: import("./actions/token.js").setUserToken.Parameters<{
            blockExplorers?: {
                [key: string]: {
                    name: string;
                    url: string;
            ...
            address: accountOrAddress;
            type: "json-rpc";
        } : accountOrAddress>) => Promise<import("./actions/token.js").setUserToken.ReturnType>;
        ...
        watchSetUserToken: (parameters: import("./actions/token.js").watchSetUserToken.Parameters) => () => void;

...
- [#129](https://github.com/tempoxyz/tempo-ts/pull/129) [`c17b66c`](https://github.com/tempoxyz/tempo-ts/commit/c17b66c3c4902f0c5fd723062c2b6a02b44a47b8) Thanks [@jxom](https://github.com/jxom)! - **Breaking:** As of `viem@2.43.0`, `tempo.ts/chains` and `tempo.ts/viem` have been upstreamed into Viem, and are no longer maintained in this repository.

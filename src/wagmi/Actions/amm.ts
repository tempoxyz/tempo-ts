 ...
 * @returns The pool ID.
 */
export function getPoolId<config extends Config>(
  config: config,
  parameters: getPoolId.Parameters<config>,
) {
  const { chainId, ...rest } = parameters
  const client = config.getClient({ chainId })
  return viem_Actions.getPoolId(client, rest)
}

export namespace getPoolId {
  export type Parameters<config extends Config> = ChainIdParameter<config> &
    viem_Actions.getPoolId.Parameters

  export type ReturnValue = viem_Actions.getPoolId.ReturnValue

  export function queryKey<config extends Config>(
    parameters: Parameters<config>,
  ) {
    return ['getPoolId', parameters] as const
  }
  ...
  export function queryOptions<config extends Config, selectData = ReturnValue>(
    ...
    return {
      ...
      async queryFn({ queryKey }) {
        ...
        return await getPoolId(config, parameters)
      },
    }
  }
  ...
  export declare namespace queryOptions {
    export type Parameters<
      ...
      selectData = getPoolId.ReturnValue,
    > = getPoolId.Parameters<config> & {
      query?:
    ...
    > = RequiredBy<
      Query.QueryOptions<
        getPoolId.ReturnValue,
        Query.DefaultError,
        selectData,
        getPoolId.QueryKey<config>
      >,
      'queryKey' | 'queryFn'
    >
  }
 ...
 * })
 *
 * const totalSupply = await Actions.amm.getTotalSupply(config, { poolId })
 * ```
 *
 * @param config - Config.
 * @param parameters - Parameters.
 ...
 */
export function getTotalSupply<config extends Config>(
  config: config,
  parameters: getTotalSupply.Parameters<config>,
) {
  const { chainId, ...rest } = parameters
  const client = config.getClient({ chainId })
  return viem_Actions.getTotalSupply(client, rest)
}

export namespace getTotalSupply {
  export type Parameters<config extends Config> = ChainIdParameter<config> &
    viem_Actions.getTotalSupply.Parameters

  export type ReturnValue = viem_Actions.getTotalSupply.ReturnValue

  export function queryKey<config extends Config>(
    parameters: Parameters<config>,
  ) {
    return ['getTotalSupply', parameters] as const
  }
  ...
  export function queryOptions<config extends Config, selectData = ReturnValue>(
    ...
    return {
      ...
      async queryFn({ queryKey }) {
        const [, parameters] = queryKey
        return await getTotalSupply(config, parameters)
      },
    }
  }
  ...
  export declare namespace queryOptions {
    export type Parameters<
      config extends Config,
      selectData = getTotalSupply.ReturnValue,
    > = getTotalSupply.Parameters<config> & {
      query?:
        | Omit<ReturnValue<config, selectData>, 'queryKey' | 'queryFn'>
        | undefined
    }
    ...
    > = RequiredBy<
      Query.QueryOptions<
        getTotalSupply.ReturnValue,
        Query.DefaultError,
        selectData,
        getTotalSupply.QueryKey<config>
      >,
      'queryKey' | 'queryFn'
    >
  }

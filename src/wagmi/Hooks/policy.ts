...
>(parameters: useGetData.Parameters<config, selectData> = {}) {
  ...
  const enabled = Boolean(policyId && (query.enabled ?? true))
...
>(parameters: useIsAuthorized.Parameters<config, selectData> = {}) {
  ...
  const enabled = Boolean(policyId && user && (query.enabled ?? true))
...
>(
  ...
  return useMutation({
    ...
    mutationKey: ['setPolicyAdminSync'],
  })
}
...
>(
  ...
  return useMutation({
    ...
    mutationKey: ['modifyPolicyWhitelist'],
  })
}
...
>(
  ...
  return useMutation({
    ...
    mutationKey: ['modifyPolicyWhitelistSync'],
  })
}
...
>(
  ...
  return useMutation({
    ...
    mutationKey: ['modifyPolicyBlacklist'],
  })
}
...
>(
  ...
  return useMutation({
    ...
    mutationKey: ['modifyPolicyBlacklistSync'],
  })
}
 ...
 *   })
 *
 *   return <div>Watching for policy creations...</div>
 * }
 * ```
 *
 * @param parameters - Parameters.
...
>(parameters: useWatchCreate.Parameters<config> = {}) {
  ...
  }, [config, enabled, onPolicyCreated, rest])
}
...
>(parameters: useWatchAdminUpdated.Parameters<config> = {}) {
  ...
  }, [config, enabled, onAdminUpdated, rest])
}
...
>(parameters: useWatchWhitelistUpdated.Parameters<config> = {}) {
  ...
  }, [config, enabled, onWhitelistUpdated, rest])
}
...
>(parameters: useWatchBlacklistUpdated.Parameters<config> = {}) {
  ...
  }, [config, enabled, onBlacklistUpdated, rest])
}
